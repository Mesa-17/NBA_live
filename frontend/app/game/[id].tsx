...
export default function GameDetailScreen() {
  ...
  const initSocket = useCallback(() => {
    ...
    socket.on('connect', () => {
      console.log('✅ Connected for game:', id);
      socket.emit('request_game_data', { game_id: id });
    });
    ...
    socket.on('new_score', handleNewScore);
  ...
  const onRefresh = async () => {
    setRefreshing(true);
    await fetchGameData();
    socketRef.current?.emit('request_game_data', { game_id: id });
    setRefreshing(false);
  };
      ...
      <ScrollView style={styles.playersList}>
        ...
        <View style={styles.teamSection}>
          <View style={styles.teamHeader}>
            ...
            <Text style={styles.teamHeaderText}>{awayTeam}</Text>
          </View>
        ...
        <View style={styles.teamSection}>
          <View style={styles.teamHeader}>
            ...
            <Text style={styles.teamHeaderText}>{homeTeam}</Text>
          </View>
        ...
        <View style={styles.gameHeader}>
          <View style={styles.headerTeams}>
            ...
            <View style={styles.headerTeamBox}>
              ...
              <Text style={styles.headerTeamCode}>{currentGameData?.away_team}</Text>
            </View>
            ...
            <View style={styles.headerTeamBox}>
              ...
              <Text style={styles.headerTeamCode}>{currentGameData?.home_team}</Text>
            </View>
          </View>
        </View>
